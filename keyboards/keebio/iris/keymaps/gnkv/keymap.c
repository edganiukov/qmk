...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
            ...
            KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_SPC, KC_MUTE, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, RSFT_T(KC_CAPS),
    ...
    [1] = LAYOUT(
            ...
            KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_NO, KC_PGDN, KC_PGUP, KC_NO, KC_NO, KC_TRNS,
